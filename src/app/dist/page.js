        ...
        React.createElement("div", { className: "min-h-screen flex flex-col md:flex-row items-start md:items-top gap-8  mt-50" },
            ...
            React.createElement(framer_motion_1.motion.div, { variants: container, initial: "hidden", whileInView: "show", viewport: { once: true }, className: "w-full md:w-1/2 grid md:grid-cols-2 grid-cols-0 lg:grid-cols-2 gap-6" },
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(JS_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "Javascript", items: ["Lógica de programação", "Estrutura de dados", "API's"] })),
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(reactlogo_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "React JS", items: ["UIX Design", "React Hooks", "Styled Components"] })),
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(tailwind_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "Tailwind CSS", items: ["UI/UX Design", "Componentes", "Responsividade", "Animações"] })),
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(figma_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "Figma", items: ["Wireframes", "Prototipagem", "UI/UX Design", "Design System"] })),
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(nodejs_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "Node.js", items: ["Servidores", "APIs REST", "Conexão com bancos de dados"] })),
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(typescript_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "TypeScript", items: ["Interfaces", "Lógica de Programação, ", "Estrutura de Dados"] })),
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(git_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "Git", items: ["Controle de versão", "Branches", "Pull Requests", "Issues"] })),
                React.createElement(framer_motion_1.motion.div, { variants: item, whileHover: { scale: 1.04 } },
                    React.createElement(skillcard_1.SkillCard, { icon: React.createElement(flutter_svg_1["default"], { className: "w-12 h-12 text-yellow-400" }), title: "Flutter", items: ["UI/UX Design", "Componentes", "Responsividade", "Animações"] })))),
